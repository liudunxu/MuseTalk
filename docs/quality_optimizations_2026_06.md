...
```
2026-06-09  604b11f  fix(api): lock face via IoU
2026-06-09  2bcda08  fix(api): face lock via center-distance
2026-06-09  0e89728  fix(api): soft face lock fallback
2026-06-09  e6f22c6  feat(render): output-level temporal blend
2026-06-09  62a3923  fix(render): stabilize bbox + skip side faces
2026-06-09  1a6d93c  feat(render): mouth-region laplacian
2026-06-09  b022880  feat(render): light color histogram check
2026-06-09  c284ca2  fix(render): soft-transition upper-face
2026-06-09  68b7fb1  loosen: relax drift + tile MSE thresholds
2026-06-09  1abcab1  fix(render): lower drift threshold + per-tile max-MSE
2026-06-09  9a82feb  fix(render): detail restore to upper face + drift fallback
2026-06-09  9177288  fix(render): color match only upper face
2026-06-09  eaf02d3  optimize: relax stability defaults
2026-06-10  3e92ae1  fix(api): CodeFormer temporal EMA + higher fidelity
2026-06-10  8e6a3db  docs(AGENTS): tuning methodology
2026-06-10  1aa48fb  feat(render): 4 badcase gates
2026-06-10  3c4ca83  fix(render): lips-only mask for blend/color/CLAHE
2026-06-10  62ceb85  fix(render): resize lips_mask to crop_box
2026-06-10  a72390e  fix(render): drop mouth CLAHE + strengthen color match
2026-06-10  2851bde  chore(cleanup): remove dead code
2026-06-10  3671e07  docs: design + plan for lips_only blend mode
2026-06-10  bff3cb8  feat(api): mouth_color_match_strength knob
2026-06-10  c771614  feat(api): thread mouth_color_match_strength
2026-06-10  214cffd  feat(blending): lips_only mode
2026-06-10  7fd6373  feat(api): accept parsing_mode='lips_only'
2026-06-10  d68a302  feat(render): tighter lips blend + lips_outer_only
2026-06-10  62e225a  perf(render): cache BiSeNet parsing per frame
2026-06-10  72cd85c  fix(api): disable quality gates by default
2026-06-10  6b0e700  fix(blend): expanded-crop lips mask
2026-06-10  87f9884  fix(api): default lips_blend_dilation to 2
2026-06-10  d3fdba6  fix(api): lower mouth_color_match_strength to 0.30
2026-06-10  7b8c49d  perf(api,blend): faster PNG writes + numpy fast-path
2026-06-10  67c2f7c  fix(api): skin mask for color match + soft mask blend
2026-06-10  90db126  fix(api): tighten CodeFormer defaults + only EMA adjacent
2026-06-10  c2d2429  fix(render): limit reference detail restore to skin
2026-06-10  58eab08  fix(render): CLAHE-based mouth color-block fix
2026-06-10  e03882c  fix(render): color-match generated mouth toward reference
2026-06-10  ba37373  fix(render): restore hard-cut color match + whole-face MSE
2026-06-10  872118f  fix(api): loosen CodeFormer internal fallback  (R)
2026-06-10  cc51e3c  fix(api): roll back over-strict quality gates
2026-06-10  a3c3100  fix(api): record quality_fallback in provenance
2026-06-10  b822dab  fix(api): enable per-tile MSE fallback by default
2026-06-10  16a44f6  fix(api): undo CodeFormer internal-fallback loosening
2026-06-11  8a382f0  feat(api): /api/faces filters silent clusters
2026-06-11  63012ec  feat(api): per-segment all-or-nothing
2026-06-11  e396ebf  feat(api): relax segment consistency to majority vote
2026-06-11  aa8a653  feat(api): time-window segment merging
2026-06-11  5374be1  feat(api): strengthen + un-gate output_temporal_blend
2026-06-12  4b4987a  feat(api): HeyGen-like segmentation phase 1
2026-06-12  ce7b684  fix(api): CodeFormer EMA tracks speaker switches
```
